package org.example.wecamadminbackend.service.util;

import lombok.RequiredArgsConstructor;
import org.example.wecamadminbackend.repos.UserRepository;
...
public class UserTagGenerator {
    ...
    public String generateUserTag(Long selectSchoolId, String name) {
        ...
        throw new IllegalArgumentException("태그 생성이 되지 않았습니다.");
    }
}
