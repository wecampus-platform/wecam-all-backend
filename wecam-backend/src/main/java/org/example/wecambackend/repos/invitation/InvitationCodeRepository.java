...
public interface InvitationCodeRepository extends JpaRepository<InvitationCode,Long> {
    ...
    @Query("SELECT new org.example.wecambackend.dto.response.invitation.InvitationCodeResponse(ic.id,ic.code, u.name, ic.codeType, ic.createdAt, ic.isActive, ic.expirationDate) " +
