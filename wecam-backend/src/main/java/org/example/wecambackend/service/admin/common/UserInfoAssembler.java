...
import org.example.wecambackend.dto.response.council.CouncilVisibleUserDTO;
...
public class UserInfoAssembler {
    ...
    public CouncilVisibleUserDTO buildUserInfo(User user) {
        String phoneNumber = findUserPhoneNumberByUserId(user.getUserPkId()); // 암호화된 전화번호 조회
     ...
     */
    public String findUserPhoneNumberByUserId(Long userId) {
